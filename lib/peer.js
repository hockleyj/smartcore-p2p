 ...
 * using the standard SmartCash protocol. A Peer instance represents one connection
 * on the SmartCash network. To create a new peer connection provide the host and port
