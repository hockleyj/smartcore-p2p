...
function builder(options) {
  ...
  if (!options.network) {
    options.network = smartcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || smartcore.Block;
  options.BlockHeader = options.BlockHeader || smartcore.BlockHeader;
  options.Transaction = options.Transaction || smartcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || smartcore.MerkleBlock;
